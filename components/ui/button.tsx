...
const buttonVariants = cva(
  ...
  {
    /* "bg-transparent border-2 border-solid border-black dark:border-white rounded-lg hover:translate-x-boxShadowX hover:translate-y-boxShadowY hover:shadow-light dark:hover:shadow-dark", */
    variants: {
      variant: {
        default:
        ...
        outlined:
          "text-black dark:text-white border dark:border-white border-black hover:translate-x-boxShadowX hover:translate-y-boxShadowY hover:shadow-none dark:hover:shadow-none  shadow-light dark:shadow-white ",
        tab: "bg-transparent backdrop-blur-sm dark:text-white text-text border border-border dark:border-white hover:shadow-none dark:hover:shadow-none",
        secondary:
          "text-text bg-transparent dark:text-white hover:translate-x-boxShadowX hover:translate-y-boxShadowY hover:shadow-none dark:hover:shadow-none",
        reverse:
